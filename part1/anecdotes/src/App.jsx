...
const App = () => {
    const anecdotes = [
        ...
        'The first 90 percent of the code accounts for the first 90 percent of the development time...The remaining 10 percent of the code accounts for the other 90 percent of the devlopment time.',
    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={handleAnecdoteButton}>random anecdote</button>
            </div>
